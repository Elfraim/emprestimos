...
<ul class="nav justify-content-center">
  <li class="nav-item" style="border-top-left-radius: 10%;">
...
<div style="" class="row g-3 align-items-center">
 ...
 <div class="row" style="
    ...
    margin-bottom: 2rem;
">
    <input placeholder="Buscar" lacetype="text" id="funcao" class="col-7" aria-describedby="passwordHelpInline" style="
    border-radius: 1rem;
    border: brown;
"> <button type="submit" name="submit" id="submit" class=" col-2 bot btn btn-primary" "="" style="margin: 0;">Pesquisar</button>
</div>
...
<div class="col-9">
    ...
    text-align: center;
"><button type="submit" name="submit" id="submit" class=" col-2 bot btn btn-primary" "="" style="margin: auto;">Devolver</button></div>
  </div>
