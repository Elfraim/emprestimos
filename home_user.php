    ...
    '; echo $user_data['quantidade'].'</li>
                ...
                <td>
                  <ul class="list-unstyled mb-0 d-flex justify-content-end">
                    ...
                    <li><a href="updateEstoque.php?id='.$user_data['id'].'&equipamento='.$user_data['equipamento'].'&quantidade='.$user_data['quantidade'].'&disponivel='.$disp.'" class="text-danger" data-toggle="tooltip" title="" data-original-title="Delete"><i class="far fa-trash-alt"></i></a></li>
                  </ul>
                </td>
