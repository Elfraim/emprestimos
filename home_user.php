...
$sql = "SELECT * FROM emprestimo   ORDER BY data_emprestimo DESC ";
 ...
 while($user= mysqli_fetch_assoc($res))
{
   ...
   $eq = $user['equipamento'];
    $qtd =$user['quantidade'];
	 ...
	 echo '<a class="btn btn-outline-primary" href="home_user.php?equipamento='.$eq.'">'.$eq.'</a>';
}
	?> 
...
<script>
  ...
  new Chart(ctx, {
    type: "bar",
    data: {
      labels: ["Quantidade", "Quantidade Disponivel"],
    datasets: [
        {
...
<?php
   $sql =" SELECT * FROM emprestimo as e inner join usuario as u where e.nome_completo = u.nome ";
    ...
    '; echo $user_data['quantidade'].'</li>
                ...
                <td>
                  <ul class="list-unstyled mb-0 d-flex justify-content-end">
                    ...
                    <li><a href="criar.php?id='.$user_data['id'].'&q='. $user_data['quantidade'].'" class="text-info" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a></li>
                    <li><a href="updateEstoque.php?id='.$user_data['id'].'&equipamento='.$user_data['equipamento'].'&quantidade='.$user_data['quantidade'].'" class="text-danger" data-toggle="tooltip" title="" data-original-title="Delete"><i class="far fa-trash-alt"></i></a></li>
                  </ul>
                </td>
